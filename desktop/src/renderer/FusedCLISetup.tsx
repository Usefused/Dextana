...
export function FusedCLISetup({ ready }: { ready: (value: boolean) => void }) {
  ...
  return <section className="fused-cli-setup" aria-label="Fused CLI setup" aria-busy={busy}>
    <div className="fused-cli-heading"><span className="fused-cli-symbol" aria-hidden="true">↓</span><div><h3>Get Fused ready</h3><p>Requires fused-cli. Dextana can install it for you.</p></div></div>
