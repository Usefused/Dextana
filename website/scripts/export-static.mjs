...
for (const [route, file, expectedStatus] of [['/', 'index.html', 200], ['/guide', 'guide/index.html', 200], ['/not-found', '404.html', 404]]) {
...
console.log('Exported the home page, guide, and 404 page to dist/.');
